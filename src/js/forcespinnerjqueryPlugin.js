/*!
 * jQuery Plugin for ForceSpinner
 * Author: @oyecode (Harshit Pandey)
...
;(function ( $ ) {
    ...
    $.forceSpinner.isEmptyString = function(toReturn){
    ...
    $.forceSpinner.generateSpinnerHtml = function(ele, spinnerType){
      var spinnerHTML;
    ...
    $.forceSpinner.forceSpin = function(elementId, spinnerType, spinnerColor, spinnerbgColor){
...
/*!
 * Usage
 * Find element by Id  => var el = $('myelement');
 * Bind spinner to element simply by calling forceSpin(el, 'google');
 * Licensed under the MIT license
 */
